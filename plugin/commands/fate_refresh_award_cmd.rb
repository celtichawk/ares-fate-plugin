    ...
    class FateRefreshAwardCmd
      ...
      def handle
        ClassTargetFinder.with_a_character(self.target_name, client, enactor) do |model|
          model.update(fate_refresh: model.refresh + self.points)
          Global.logger.info "#{enactor_name} awarded #{self.points} fate refreshes to #{self.target_name}."
